        ...
        <div className="flex flex-col items-center w-full">
            <div className="w-full bg-white dark:bg-[#0c1810] rounded-2xl border border-slate-200 dark:border-emerald-900/60 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-500">
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50/80 dark:bg-emerald-950/40 border-b border-slate-100 dark:border-emerald-900/40">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-emerald-900/20">
                        {[0, 1, 2, 3, 4, 5].map((n) => {
                            ...
                            return (
                                <tr key={n} className="hover:bg-slate-50/50 dark:hover:bg-emerald-900/10 transition-colors">
                                    <td className="py-2.5 px-3 text-sm font-bold text-slate-900 dark:text-emerald-50 text-center">{n}</td>
