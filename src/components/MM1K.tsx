    ...
    if (!Number.isInteger(kParam)) {
      return (
        <div className="bg-yellow-50 dark:bg-yellow-950/30 text-yellow-800 dark:text-yellow-400 p-4 rounded-xl mt-6 border border-yellow-200 dark:border-yellow-900">
          <p className="text-sm">
            La capacidad máxima del sistema (K) debe ser un número entero.
          </p>
        </div>
      );
    }
            ...
            <div className="mb-6 space-y-4">
                ...
                <div className="bg-white dark:bg-[#12091c] rounded-2xl border border-slate-200 dark:border-purple-900/60 shadow-sm dark:shadow-black/40 overflow-hidden">
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label htmlFor="mm1k-lambda" className="block text-sm font-medium text-slate-700 dark:text-purple-400 mb-1">
                                    Tasa de Llegada (λ)
                                </label>
                                <input
                                    id="mm1k-lambda"
                            ...
                            <div>
                                <label htmlFor="mm1k-mu" className="block text-sm font-medium text-slate-700 dark:text-purple-400 mb-1">
                                    Tasa de Servicio (μ)
                                </label>
                                <input
                                    id="mm1k-mu"
                        ...
                        <div>
                            <label htmlFor="mm1k-k" className="block text-sm font-medium text-slate-700 dark:text-purple-400 mb-1">
                        ...
                        <div className="pt-2 border-t border-slate-100 dark:border-purple-900/30">
                            <label htmlFor="mm1k-pn" className="block text-sm font-medium text-slate-700 dark:text-purple-400 mb-1">
